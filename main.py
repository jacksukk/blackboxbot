...
def main():
    ...
    batch = 0
    args.save_steps = list(map(int, args.save_steps.split(',')))
...
def set_arguments(parser):
    ...
    parser.add_argument("--save_steps",type=str, default="50,500")
    ...
    parser.add_argument("--coh_r", type=float, default=0)
